                            ...
                            <Row>
                                <Col lg={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="text" name="nama-pemesan" placeholder="Masukkan Nama Lengkap" />
                                    </Form.Group>
                                </Col>
                                <Col lg={4}>
                                    <Form.Group>
                                        <Form.Label>Nomor Telpon</Form.Label>
                                        <Form.Control type="text" name="telpon" placeholder="cth. 08123456789" />
                                    </Form.Group>
                                </Col>
                            </Row>
                            <Row>
                                ...
                                <Col lg={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Control type="number" name="jumlah-orang" min={2} value={jumlah} onChange={handleJumlahChange} />
                                    </Form.Group>
                                </Col>
                            </Row>
                        </div>
                            ...
                            <Row>
                                ...
                                <Col lg={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Select aria-label="waktu-mulai" onChange={handleStartTimeChange}>
                                            <option>--</option>
                                ...
                                <Col lg={2}>
                                    <Form.Group>
                                        ...
                                        <Form.Select aria-label="sampai" disabled={!startTime} onChange={handleEndTimeChange}>
                                            <option>--</option>
                            ...
                            <Row>
                                <Col lg={4}>
                                    <Form.Group>
                                        ...
                                        <Form.Select aria-label="pembayaran" onChange={handlePaymentMethodChange}>
